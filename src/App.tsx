...
const Onboarding = ({ onComplete }) => {
  ...
  return (
    step === 0 ? (
      <div className="fixed inset-0 z-[100] bg-gradient-to-br from-slate-800 to-slate-950 bg-[url('https://www.transparenttextures.com/patterns/noisy-net.png')] bg-blend-overlay text-white flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-300">
